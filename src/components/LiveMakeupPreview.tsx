...
// export const LiveMakeupPreview: React.FC = () => {
...
//   // Инициализация камеры и FaceMesh
//   useEffect(() => {
...
//   // Основная функция обработки результатов FaceMesh
...
//   // Переводим нормализованные координаты landmark в canvas
